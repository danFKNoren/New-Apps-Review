    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          ...
          <p className="login-subtitle">HubSpot Deals Overview</p>
        </div>

        <div className="login-body">
          <p className="login-description">
            Sign in with your Jedyapps Google account to access the dashboard
          </p>
          ...
          <p className="login-note">
            Only @jedyapps.com accounts can access this dashboard
          </p>
        </div>
      </div>
    </div>
